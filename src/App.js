...
import { clearfilter } from "./redux/blog/actionType";
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-end">
            <button onClick={() => dispatch(clearfilter())} className="px-3 py-2 rounded cursor-pointer bg-indigo-100">Clear</button>
